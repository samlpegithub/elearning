...
const Courses = () => {
  ...
  return (
    <div className=' w-[90%] 800px:m-auto'>
      ...
      <br />
      <br />
      <div className='grid  items-center ml-6 800px:ml-0 grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] 1500px:grid-cols-4 150px:gap-[35px] 800px:mb-28 '>
